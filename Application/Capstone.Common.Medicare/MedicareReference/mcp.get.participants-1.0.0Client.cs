...
namespace Capstone.Common.Medicare.ThirdParty.MedicareOnline.GPRW
{
    ...
    public partial class GetParticipants 
    {
        ...
        public GetParticipants(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<GetParticipantsResponseType> McpGetParticipants(GetParticipantsRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey)
        {
            return McpGetParticipants(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType,apiKey, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<GetParticipantsResponseType> McpGetParticipants(GetParticipantsRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/mcp/getparticipants/v1");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetParticipantsResponseType>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(GetParticipantsResponseType);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public partial class GetParticipantsRequestType 
    {
        [Newtonsoft.Json.JsonProperty("participantType", Required = Newtonsoft.Json.Required.Always)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GetParticipantsResponseType 
    {
        [Newtonsoft.Json.JsonProperty("participant", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        public System.Collections.Generic.ICollection<CapabilityType> Participant { get; set; } = new System.Collections.ObjectModel.Collection<CapabilityType>();
    ...
    public partial class CapabilityType 
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        public System.Collections.Generic.ICollection<string> Service { get; set; } = new System.Collections.ObjectModel.Collection<string>();
