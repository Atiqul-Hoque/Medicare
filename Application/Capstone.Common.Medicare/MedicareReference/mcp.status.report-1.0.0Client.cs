...
namespace Capstone.Common.Medicare.ThirdParty.MedicareOnline.STSW
{
    ...
    public partial class StatusReport 
    {
        ...
        public StatusReport(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<StatusReportResponseType> McpStatusReport(StatusReportRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType, string apiKey)
        {
            return McpStatusReport(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType, apiKey,System.Threading.CancellationToken.None );
        }
