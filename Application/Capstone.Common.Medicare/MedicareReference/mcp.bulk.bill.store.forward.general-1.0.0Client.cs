...
namespace Capstone.Common.Medicare.ThirdParty.MedicareOnline.BulkBill.General
{
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.5.0 (NJsonSchema v10.0.22.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class BulkBillGeneral 
    {
        private string _baseUrl = Medicare.Properties.Resources.BaseURL;
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public BulkBillGeneral(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<BulkBillStoreForwardResponseType> McpBulkBillStoreForwardGeneral(BulkBillStoreForwardRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey,string endPoint)
        {
            return McpBulkBillStoreForwardGeneral(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType,apiKey,endPoint, System.Threading.CancellationToken.None);
        }
