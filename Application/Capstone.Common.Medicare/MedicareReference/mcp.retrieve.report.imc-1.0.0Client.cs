...
namespace Capstone.Common.Medicare.ThirdParty.MedicareOnline.RTVW
{
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.5.0 (NJsonSchema v10.0.22.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class RetrieveReport 
    {
        private string _baseUrl = Medicare.Properties.Resources.BaseURL;
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public RetrieveReport(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<RetrieveReportResponseType> McpRetrieveReportImc(RetrieveReportRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType, string apiKey)
        {
            return McpRetrieveReportImc(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType, apiKey,System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<RetrieveReportResponseType> McpRetrieveReportImc(RetrieveReportRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/mcp/inpatientmedicalclaim/retrievereport/v1");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            Console.WriteLine("Response from API is below =============");
                            Console.WriteLine(Newtonsoft.Json.JsonConvert.SerializeObject(response_.Content));
    ...
    //[JsonInheritanceAttribute("InPatientMedicalClaimReportContentType", typeof(InPatientMedicalClaimReportContentType))]
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class ContentType 
    {
        ...
        public InPatientMedicalClaimResponseType Report { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class InPatientMedicalClaimReportContentType : ContentType
    {
        [Newtonsoft.Json.JsonProperty("report", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public InPatientMedicalClaimResponseType Report { get; set; }
