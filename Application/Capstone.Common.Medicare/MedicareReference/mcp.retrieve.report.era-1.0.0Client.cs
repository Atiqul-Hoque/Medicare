...
namespace Capstone.Common.Medicare.ThirdParty.MedicareOnline.ERA
{
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.5.0 (NJsonSchema v10.0.22.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class EclipseRemittanceAdvice 
    {
        private string _baseUrl = Medicare.Properties.Resources.BaseURL;
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public EclipseRemittanceAdvice(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<RetrieveReportResponseType> McpRetrieveReportEra(RetrieveReportRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey)
        {
            return McpRetrieveReportEra(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType,apiKey, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<RetrieveReportResponseType> McpRetrieveReportEra(RetrieveReportRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/mcp/eclipseremittanceadvice/retrievereport/v1");
    ...
    //[JsonInheritanceAttribute("EclipseRemittanceAdviceReportContentType", typeof(EclipseRemittanceAdviceReportContentType))]
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class ContentType 
    {
        ...
        public EclipseRemittanceAdviceReportType Report { get; set; }

    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EclipseRemittanceAdviceReportContentType : ContentType
    {
        [Newtonsoft.Json.JsonProperty("report", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public EclipseRemittanceAdviceReportType Report { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EclipseRemittanceAdviceReportType 
    {
        [Newtonsoft.Json.JsonProperty("partNumber", Required = Newtonsoft.Json.Required.Always)]
        public int PartNumber { get; set; }
    
        [Newtonsoft.Json.JsonProperty("partTotal", Required = Newtonsoft.Json.Required.Always)]
        public int PartTotal { get; set; }
    
        [Newtonsoft.Json.JsonProperty("payeeLocationId", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string PayeeLocationId { get; set; }
    
        [Newtonsoft.Json.JsonProperty("remittanceAdviceId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string RemittanceAdviceId { get; set; }
    
        [Newtonsoft.Json.JsonProperty("paymentInfo", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public PaymentType PaymentInfo { get; set; } = new PaymentType();
    
        [Newtonsoft.Json.JsonProperty("paymentRun", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public PaymentRunType PaymentRun { get; set; } = new PaymentRunType();
    
        [Newtonsoft.Json.JsonProperty("claimSummary", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        public System.Collections.Generic.ICollection<RemittanceAdviceClaimSummaryType> ClaimSummary { get; set; } = new System.Collections.ObjectModel.Collection<RemittanceAdviceClaimSummaryType>();
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class RemittanceAdviceClaimSummaryType : EclipseClaimSummaryType
    {
        ...
        [Newtonsoft.Json.JsonProperty("previousAccountReferenceId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PreviousAccountReferenceId { get; set; }
    
    
    }
    
    //[Newtonsoft.Json.JsonConverter(typeof(JsonInheritanceConverter), "eclipseClaimSummaryType")]
    //[JsonInheritanceAttribute("RemittanceAdviceClaimSummaryType", typeof(RemittanceAdviceClaimSummaryType))]
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
