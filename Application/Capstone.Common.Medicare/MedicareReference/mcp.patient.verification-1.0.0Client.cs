...
namespace Capstone.Common.ThirdParty.MedicareOnline
{
    ...
    public partial class Verification
    {
        ...
        public Verification(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<PatientVerificationResponseType> McpPatientVerification(PatientVerificationRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey, string endpoint)
        {
            return McpPatientVerification(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType,apiKey, endpoint,System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PatientVerificationResponseType> McpPatientVerification(PatientVerificationRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType,string apiKey, string endpoint, System.Threading.CancellationToken cancellationToken)
        {
...
//namespace Capstone.Common.Medicare.ThirdParty.MedicareOnline
//{
//    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.5.0 (NJsonSchema v10.0.22.0 (Newtonsoft.Json v11.0.0.0))")]
//    public partial class Verification
//    {
...
//        /// <returns>successful operation</returns>
//        /// <exception cref="ApiException">A server side error occurred.</exception>
//        public System.Threading.Tasks.Task<PatientVerificationResponseType> McpPatientVerification@1EigwAsync(PatientVerificationRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType)
//        {
//            return McpPatientVerification@1EigwAsync(body, authorization, dhs_auditId, dhs_subjectId, dhs_messageId, dhs_auditIdType, dhs_correlationId, dhs_productId, dhs_subjectIdType, System.Threading.CancellationToken.None);
//        }
...
//        /// <returns>successful operation</returns>
//        /// <exception cref="ApiException">A server side error occurred.</exception>
//        public async System.Threading.Tasks.Task<PatientVerificationResponseType> McpPatientVerification@1EigwAsync(PatientVerificationRequestType body, string authorization, string dhs_auditId, string dhs_subjectId, string dhs_messageId, string dhs_auditIdType, string dhs_correlationId, string dhs_productId, string dhs_subjectIdType, System.Threading.CancellationToken cancellationToken)
//        {
//            var urlBuilder_ = new System.Text.StringBuilder();
